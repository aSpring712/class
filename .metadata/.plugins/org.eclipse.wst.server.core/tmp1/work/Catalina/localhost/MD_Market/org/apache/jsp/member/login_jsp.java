 ...
 * Generated at: 2021-04-02 06:27:57 UTC
...
public final class login_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t<form action=\"/action_page.php\" class=\"was-validated\">\r\n");
      out.write("\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t<label for=\"userid\">아이디</label> \r\n");
      out.write("\t\t\t<input type=\"text\" class=\"form-control\" id=\"userid\" placeholder=\"Enter userid\" name=\"userid\" required>\r\n");
      ...
      out.write("    \t\t<div class=\"invalid-feedback\">Please fill out this field.</div>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t<button type=\"button\" class=\"btn btn-primary\" id=\"loginBtn\">Submit</button>\r\n");
      out.write("\t</form>\r\n");
      out.write("</div>\r\n");
      out.write("\r\n");
      out.write("<script>\r\n");
      out.write("$(\"#loginBtn\").click(function() { /* 프로그램 -> 위에서부터 아래로 내려오기 때문에 여기에 써주면 위에 loginBtn이 있기 때문에 인식 가능. 만약 이걸 위에 써주면 인식을 하지 못하기 때문에 $(document).ready(function({ 해주어야 함 */\r\n");
      ...
      out.write("\t$.ajax({\r\n");
      out.write("\t\ttype : \"post\",\r\n");
      out.write("\t\turl : \"login\", // sendRedirect에 login 적었으므로\r\n");
      out.write("\t\tdata : {\"userid\" : $(\"#userid\").val(), \"pwd\" : $(\"#pwd\").val()},\r\n");
      out.write("\t\tsuccess : function(resp) { // 0 일반 1 관리자 -1 비회원 2 비번오류\r\n");
      out.write("\t\t\tif(resp.trim()==0) {\r\n");
      out.write("\t\t\t\t$(location).attr(\"href\", \"../index.jsp\"); // jqeury, 상대경로\r\n");
      out.write("\t\t\t} else if(resp.trim() == 1) {\r\n");
      out.write("\t\t\t\talert(\"관리자 로그인\");\r\n");
      out.write("\t\t\t\tlocation.href=\"orderlist\" // 자바 스크립트, action으로 보냄\r\n");
      out.write("\t\t\t} else if(resp.trim() == -1) {\r\n");
